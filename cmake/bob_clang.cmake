if (CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
	...
	if (${BOB_CLANG_TIDY})
		...
		set(CMAKE_C_CLANG_TIDY "clang-tidy;-checks=abseil-*,bugprone-*,clang-analyzer-*,cppcoreguidelines-*,misc-*,readability-*,modernize-*,performance-*;--header-filter=.")
		set(CMAKE_CXX_CLANG_TIDY "clang-tidy;-checks=abseil-*,bugprone-*,clang-analyzer-*,cppcoreguidelines-*,misc-*,readability-*,modernize-*,performance-*;--header-filter=.")
	endif()
